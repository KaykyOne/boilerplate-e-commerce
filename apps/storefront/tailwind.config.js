    ...
    extend: {
      ...
      colors: {
        brand: {
          ...
          contrast: "rgb(var(--color-primary-foreground) / <alpha-value>)",
          ...
          image: "rgb(var(--color-image-background) / <alpha-value>)",
          decorative: "rgb(var(--color-decorative) / <alpha-value>)",
          header: "rgb(var(--color-header-secondary) / <alpha-value>)",
